//RUN: SampleScripts.CudaBlas.Simple.Run
using System;
...
namespace SampleScripts.CudaBlas
{
    public class Simple
    {
        public static void Run()
        {
            ...
            float ref_norm;
            float diff;
            ManagedCuda.CudaBlas.CudaBlas handle;

            /* Initialize CUBLAS */
            Console.WriteLine("simpleCUBLAS test running.");

            handle = new ManagedCuda.CudaBlas.CudaBlas();
            ...
            SimpleSgemm(N, alpha, h_A, h_B, beta, h_C_ref);
        ...
        static void SimpleSgemm(int n, float alpha, float[] A, float[] B, float beta, float[] C)
        {
            int i;
            int j;
            int k;
